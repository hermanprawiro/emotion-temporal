...
def main(args):
    ...
    save_name = "{}_dense_{}_{:d}seg_split{:d}_bs{}_wd{}".format(args.arch, args.dataset, args.n_segments, args.split, args.batch_size, args.weight_decay)
    if args.comment != '':
    ...
    net = Network(arch=args.arch).to(device)
